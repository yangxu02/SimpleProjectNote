...
//
// $URL: https://htmlparser.svn.sourceforge.net/svnroot/htmlparser/tags/HTMLParserProject-2.1/parser/src/main/java/org/htmlparser/util/Translate.java $
// $Author: derrickoswald $
// $Date: 2007-03-04 20:42:01 +0100 (Sun, 04 Mar 2007) $
// $Revision: 30 $
//
...
public class Translate
{
     ...
     * Look up a reference by kernel.
     * Use a binary search on the ordered list of known references.
     * <em>This is not very efficient, use {@link Translate#lookup(org.htmlparser.util.CharacterReference) lookup(CharacterReference)}
     * instead.</em>
